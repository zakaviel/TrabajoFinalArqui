...
{
    public class MvcShoppingInitializer : DropCreateDatabaseIfModelChanges<MusicStoreEntities>
    {
        protected override void Seed(MusicStoreEntities context)
        {
            var genres = new List<Genre>
            {
                new Genre { Name = "Rock",Description="Its The Best Music!" },
                new Genre { Name = "Jazz" ,Description="Its The Best Music!" },
                new Genre { Name = "Metal" ,Description="Its The Best Music!" },
                new Genre { Name = "Alternative" ,Description="Its The Best Music!" },
                new Genre { Name = "Disco" ,Description="Its The Best Music!" },
                new Genre { Name = "Blues" ,Description="Its The Best Music!" },
                new Genre { Name = "Latin" ,Description="Its The Best Music!" },
                new Genre { Name = "Reggae" ,Description="Its The Best Music!" },
                new Genre { Name = "Pop" ,Description="Its The Best Music!" },
                new Genre { Name = "Classical" ,Description="Its The Best Music!" }
            };
